...
public class WSSecurityHeaderSOAPHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public boolean handleMessage(SOAPMessageContext soapMessageContext) {
		...
		if (outboundProperty.booleanValue()) {
			...
			try {
				SOAPEnvelope soapEnvelope = soapMessageContext.getMessage().getSOAPPart()
						.getEnvelope();
				...
				SOAPElement soapElementSecurityHeader = header.addChildElement(
						SOAP_ELEMENT_SECURITY, PREFIX_SECURITY, NAMESPACE_SECURITY);
				...
				SOAPElement soapElementUsername = soapElementUsernameToken
						.addChildElement(SOAP_ELEMENT_USERNAME, PREFIX_SECURITY);
				soapElementUsername.addTextNode(this.usernameText);

				SOAPElement soapElementPassword = soapElementUsernameToken
						.addChildElement(SOAP_ELEMENT_PASSWORD, PREFIX_SECURITY);
